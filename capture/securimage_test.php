...
<br />The <a href="http://php.net/imageftbbox" target="_new">imageftbbox()</a> function is not required with your gd build.  This function is required.</li>
<?php endif; ?></li>
...
<?php print_status($gd_support && ($gd_info['JPG Support'] || $gd_info['JPEG Support'])); ?></li>
